...
export const problems = pgTable('Problem', {
  ...
  solutionRecursion: text('solutionRecursion').notNull(),
  solutionMemoization: text('solutionMemoization').notNull(),
  solutionTabulation: text('solutionTabulation').notNull(),
  solutionSpaceOptimized: text('solutionSpaceOptimized').notNull(),
